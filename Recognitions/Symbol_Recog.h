...
private:
	...
	std::pair<string, float> Detect_Symbols(Mat plate)
	{
			...
			Mat inputBlob = blobFromImage(frame, 1./127.5, Size(siZe, siZe), Scalar::all(127.5), true, false);
